# -*- coding: utf-8 -*-
"""
Created on Sat Oct  9 10:23:11 2021
...
def visualization(x, path, video_id):
    x.plot(figsize=(50,15), grid=True, title="Catch Highlights")
    plt.xlabel("sec")
    plt.savefig(path + "/graph/"+ video_id + '.png')



"""실행 코드"""
# json 파일 열기
#json_path = "./json/temp.json"
...
def main(argv):
    ...
    #json_path = "C:/Users/jinh2/Desktop/2021-2/capstone/pythonProgram/json/724229279.json"
    #graph_path = "C:/Users/jinh2/Desktop/2021-2/capstone/pythonProgram/json"
    
    ### for local
    #path = "C:/Users/jinh2/Desktop/2021-2/capstone/DreamChat_Demo_01/DreamChat_Demo_01/src/main/resources/static"
    ### for ubuntu
    path = "/home/ubuntu/highlive/DreamChat_Demo_01/DreamChat_Demo_01/src/main/resources/static"  

    json_path = path + "/json"
    
    video_id = argv[1]
    
    with open(json_path+"/"+video_id+".json", encoding='UTF-8') as jFile:
        json_data = json.load(jFile)
    ...
    # 그래프 저장
    visualization(moving_avg, path, video_id)
